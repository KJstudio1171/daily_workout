          ...
          InkWell(
            ...
            onTap: () {
              final Uri emailScheme = Uri(
                  ...
                  queryParameters: {'subject': 'Questions&Comments'});
          ...
          ExpansionTile(
            ...
            children: [
              Container(
                ...
                child: Text('Hello.'
                    '\n\n'
                    'Thank you for downloading Daily Workout.'
                    '\n\n'
                    '1.0.0 Version of Daily Workout may have some bugs and lack functionality. '
                    '\n\n'
                    'I would appreciate it if you could send me an e-mail with '
                    'some errors or parts that you think would be better to improve.'
                    '\n\n'
                    'If you use g-mail, you can send it right away by pressing the "Contact us" button.'
                    'Otherwise, you can send it to eddyfunfun@gmail.com.'
                    '\n'),
              )
            ],
          ),
